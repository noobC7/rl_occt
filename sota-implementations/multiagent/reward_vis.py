...
def get_experiment_metrics_and_visualize(exp_cuid: str):
    ...
    ax1.plot(
        ...
        experiment_1_data["train_reward_reward_mean"],
        label="Mean Reward",
    ...
    ax1.plot(
        experiment_1_data.index,
        experiment_1_data["train_reward_reward_min"],
        label="Min Reward",
        linewidth=1.0,
        color='#F18F01',  # 最小值线条色
        alpha=0.7
    ...
    ax1.fill_between(
        ...
        experiment_1_data["train_reward_reward_min"],  # 下界
        experiment_1_data["train_reward_reward_max"],  # 上界
...
if __name__ == "__main__":
    ...
    get_experiment_metrics_and_visualize("nnl7hk6qcz7yog1j54odv")